...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kepmodel-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13590&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kepmodel-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kepmodel` can be installed with:

```
conda install kepmodel
```

It is possible to list all of the versions of `kepmodel` available on your platform with:
